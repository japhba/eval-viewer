"""method_bench viewer blueprint (mounted at `/`): task x method score
...
def _conn():
    ...
    return Conn(config.bench_db_url)
...
# ---------- API ----------
@bench.route("/api/version_status")
...
@bench.route("/api/cluster_repeats")
...
@bench.route("/api/cluster_meta_score")
...
@bench.route("/api/filter_options")
...
@bench.route("/api/scorer_paradigms")
...
@bench.route("/api/cell/<lora_id>/<qa_id>")
...
@bench.route("/api/agent_run/<run_id>")
...
@bench.route("/api/haiku_oneliner", methods=["POST"])
...
@bench.route("/api/agent_run_summary")
